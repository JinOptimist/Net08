...
namespace WebMazeMvc.Migrations
{
    ...
    [Migration("20210820181727_BanksToUsersAndBanksImgs")]
    partial class BanksToUsersAndBanksImgs
    {
            ...
            modelBuilder.Entity("BankUser", b =>
                {
                    ...
                    b.Property<long>("MyBanksId")
                        .HasColumnType("bigint");

                    b.HasKey("ClientsId", "MyBanksId");

                    b.HasIndex("MyBanksId");
            ...
            modelBuilder.Entity("BankUser", b =>
                {
                    ...
                    b.HasOne("WebMazeMvc.EfStuff.Model.Bank", null)
                        .WithMany()
                        .HasForeignKey("MyBanksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
